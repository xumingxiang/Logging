...
namespace Logging.Server.Site
{
    ...
    public class ApiController : System.Web.Http.ApiController
    {
        ...
        public dynamic LogViewer(long start, long end, int appId, string level, string title, string msg, string ip, string source, int limit, string tags)
        {
        ...
        public dynamic StatisticsViewer(long start, long end, int appId)
        {
